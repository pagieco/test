...
/* harmony import */ var _state_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./state/store */ "./resources/modules/workflow-editor/js/state/store.js");

 // eslint-disable-next-line no-new

new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#app',
  store: _state_store__WEBPACK_IMPORTED_MODULE_1__["default"],
  components: {
    Editor: Editor
  },
  template: '<Editor />'
...
/***/ "./resources/modules/workflow-editor/js/state/modules sync recursive ^((?!index|\\.unit\\.).)*\\.js$":
/*!**********************************************************************************************!*\
  !*** ./resources/modules/workflow-editor/js/state/modules sync ^((?!index|\.unit\.).)*\.js$ ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
webpackEmptyContext.id = "./resources/modules/workflow-editor/js/state/modules sync recursive ^((?!index|\\.unit\\.).)*\\.js$";

/***/ }),

/***/ "./resources/modules/workflow-editor/js/state/modules/index.js":
/*!*********************************************************************!*\
  !*** ./resources/modules/workflow-editor/js/state/modules/index.js ***!
  \*********************************************************************/
...
(function updateModules() {
  ...
  var requireModule = __webpack_require__("./resources/modules/workflow-editor/js/state/modules sync recursive ^((?!index|\\.unit\\.).)*\\.js$");
  ...
  requireModule.keys().forEach(function (fileName) {
    ...
    var modulePath = fileName.replace(/^\.\//, '').replace(/\.\w+$/, '').split(/\//).map(lodash__WEBPACK_IMPORTED_MODULE_0__["camelCase"]); // Get the modules object for the current path.
...
/***/ "./resources/modules/workflow-editor/js/state/store.js":
/*!*************************************************************!*\
  !*** ./resources/modules/workflow-editor/js/state/store.js ***!
  \*************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _modules__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules */ "./resources/modules/workflow-editor/js/state/modules/index.js");
